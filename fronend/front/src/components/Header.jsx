      ...
      <AnimatePresence>
        {isPopupOpen && (
          <motion.div
            ...
            animate="open"
            exit="closed"
            className="fixed top-1/4 left-auto md:left-1/3 transform -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-sm sm:max-w-md bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl shadow-cyan-500/20 z-50 p-4 sm:p-6 mx-auto"
          >
